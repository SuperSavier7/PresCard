...
public class PresCard {
    ...
    public static void handGive() {
        int[] playerHand={masDeck.GimmeCardFace(masDeck.randomCard),masDeck.GimmeCardFace(masDeck.randomCard),masDeck.GimmeCardFace(masDeck.randomCard),masDeck.GimmeCardFace(masDeck.randomCard),masDeck.GimmeCardFace(masDeck.randomCard)};
